...
from pageobjects.PIM.OH_PIM_Reporting_Methods import OH_PIM_Configuration_RM
...
class Test_OH_PIM_Config_CF(Test_001_OH_Login):
    ...
    def test_config_opf(self):
        ...
        self.logger.info("*************** Clicking on Reporting Methods in Configurations Module *****************")
        self.pim_conf_tr = OH_PIM_Configuration_RM(self.driver)
        self.pim_conf_tr.reporting_methods()
        # self.logger.info("*************** Clicking on Add in Termination Reasons  *****************")
        # self.pim_conf_tr.rm_add()
